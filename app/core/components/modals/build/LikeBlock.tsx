...
import { useRef, useState, useEffect, forwardRef, RefObject } from "react"
...
const LikeBlock = forwardRef(
  (
    { liked, loading = false, hovered }: { liked?: boolean; loading?: boolean; hovered?: boolean },
